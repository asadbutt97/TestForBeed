...
namespace TestForBeed.Controllers
{
    [Route("api/products")]
    public class ProductsController : Controller
    {
        ...
        public ProductsController(TestDbContext context, ProductRepository repository)
        {
            _context = context;
        ...
        {
            var testDbContext = _context.Products.Include(p => p.Category);
